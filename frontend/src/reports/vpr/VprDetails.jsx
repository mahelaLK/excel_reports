...
const VprDetails = ({vesselName, inwardVoyage}) => {
  ...
  return (
    <div className='flex flex-col mt-4'>
        <button onClick={()=>exportVprStyled(vesselName, inwardVoyage, gwTime, bTime, vprDetails, maxRowTotalItem)} className='bg-green-900 text-green-100 px-2 py-1 my-3 rounded-lg flex gap-2 justify-center items-center'>Export to Excel <IoMdDownload/></button>
