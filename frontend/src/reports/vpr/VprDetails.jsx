...
const VprDetails = ({vesselName, inwardVoyage}) => {

    const {vprDetails, grossWorkingTime, exportVprStyled} = useContext(PortContext);
  ...
  return (
    <div className='flex flex-col mt-4'>
        <button onClick={()=>exportVprStyled(vesselName, inwardVoyage, gwTime, bTime, vprDetails, maxRowTotalItem)} className='bg-green-900 text-green-100 px-2 py-1 my-3 rounded-lg flex gap-2 justify-center items-center'>Export to Excel <RiFileExcel2Fill /></button>
        ...
        <table id='vprTable' border="1" cellPadding="5" className='w-full border-collapse bg-neutral-100'>
            <tbody>
                ...
                <tr className='border-b-1 border-neutral-700 bg-neutral-200'>
                    ...
                    {ciValue > 0 
                    ?   (<>
                            <td className='pl-2 border-l-1' colSpan={4}>CI</td>
                            <td className='text-center pl-2 border-l-1 bg-neutral-100'>{ciValue}</td>
                        </>)
                    :   (<td className='border-l-1 bg-neutral-100' colSpan={5}></td>)}
                </tr>
                ...
                <tr className='border-b-1 border-neutral-700 bg-neutral-100'>
                    <td className='pl-2 bg-neutral-200' colSpan={4}>Gross Crane Productivity</td>
                    <td className='px-2 text-center border-l-1' colSpan={2}>{grossCraneProductivity}</td>
                    <td colSpan={4}></td>
                </tr>
                <tr className='border-b-1 border-neutral-700 bg-neutral-100'>
                    <td className='pl-2 bg-neutral-200' colSpan={4}>Net Crane Productivity </td>
                    <td className='px-2 text-center border-l-1' colSpan={2}>{netCraneProductivity}</td>
                    <td colSpan={4}></td>
                </tr>
                <tr className='border-b-1 border-neutral-700 bg-neutral-100'>
                    <td className='pl-2 bg-neutral-200' colSpan={4}>Ships Rate Productivity</td>
                    <td className='px-2 text-center border-l-1' colSpan={2}>{shipsRateProductivity}</td>
                    <td colSpan={4}></td>
                </tr>
                <tr className='border-b-1 border-neutral-700 bg-neutral-200'>
