  ...
  const { gangDetailCars, exportTableStyledCar } = useContext(PortContext);
    ...
    return (
      <div className='flex flex-col mt-4'>
        <button onClick={()=>exportTableStyledCar(vesselName)} className='bg-green-900 text-green-100 px-2 py-1 my-3 rounded-lg flex gap-2 justify-center items-center w-full'>Export to Excel <RiFileExcel2Fill /></button>
        {/* === Gang Summary Table === */}
          ...
          <tbody>
            ...
            <tr className='border-b-2 border-neutral-700 bg-neutral-200'>
              {gangDetailCars.gangPlanDetails.map((plan) => {
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                   return(
                    <td colSpan={3+(gangDetailCars.gangPlanDetails.length * 4)} className='text-center'>VESSEL NAME/VOYAGE: {vesselName}</td>
                  )
                }
              })}
            </tr>
            ...
            <tr className='border-b-1 border-neutral-700 bg-neutral-200'>
              {gangDetailCars.gangPlanDetails.map((plan) => {
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                   return(
                    <td colSpan={3+(gangDetailCars.gangPlanDetails.length * 4)} className='text-center'>Berthside : {gangDetailCars.berthSide}</td>
                  )
                }
              })}
            </tr>
            ...
            <tr className='border-b-1 border-neutral-600'>
              ...
              {gangDetailCars.gangPlanDetails.map((plan) => {
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                  return(
                    <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.Crane}</td>
                  )
                }
                if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                  return(
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                   return(
                    <td key={plan.gangNumber} colSpan={4} className='border-x-1 border-neutral-400 px-2'>{details.Crane}</td>
                  )
                }
              })}
            </tr>
            ...
            <tr className='border-b-1 border-neutral-600'>
              ...
              {gangDetailCars.gangPlanDetails.map((plan) => {
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                  return(
                    <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.ListOfBays}</td>
                  )
                }
                if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                  return(
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                   return(
                    <td key={plan.gangNumber} colSpan={4} className='border-x-1 border-neutral-400 px-2'>{details.ListOfBays}</td>
                  )
                }
              })}
            </tr>
            ...
            <tr className='border-b-1 border-neutral-500'>
              ...
              {gangDetailCars.gangPlanDetails.map((plan) => {
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                  return(
                    <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.NoOfVehicles}</td>
                  )
                }
                if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                  return(
                    <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.BBLK}</td>
                  )
                }
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                   return(
              ...
              {gangDetailCars.gangPlanDetails.map((plan)=>{
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                  return(
                    <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-200'>
                      {gangDetailCars.gangPlanDetails.reduce((sum, plan) => sum + (Number(plan.details.NoOfVehicles) || 0), 0)}
                    </td>
                  )
                }
                if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                  return(
                    <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-200'>
                      {gangDetailCars.gangPlanDetails.reduce((sum, plan) => sum + (Number(plan.details.BBLK) || 0), 0)}
                    </td>
                  )
                }
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                  ...
                  <tr className='border-b-1 border-neutral-500'>
                    ...
                    {gangDetailCars.gangPlanDetails.map((plan)=>{
                      ...
                      if(details.ApwNoOfVehicles !== 0 && details.ApwBBLK === 0){
                        return(
                          <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-200'>
                            {gangDetailCars.gangPlanDetails.reduce((sum, plan) => sum + (Number(plan.details.ApwNoOfVehicles) || 0), 0)}
                          </td>
                        )
                      }
                      if(details.ApwNoOfVehicles === 0 && details.ApwBBLK !== 0){
                        return(
                          <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-200'>
                            {gangDetailCars.gangPlanDetails.reduce((sum, plan) => sum + (Number(plan.details.ApwBBLK) || 0), 0)}
                          </td>
                        )
                      }
                      if(details.ApwNoOfVehicles !== 0 && details.ApwBBLK !== 0){
                ...
                return (
                  <tr className='border-b-1 border-neutral-500'>
                    ...
                    {gangDetailCars.gangPlanDetails.map((plan) => {
                      ...
                      if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                        return(
                          <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.Overstow}</td>
                        )
                      }
                      if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                        return(
                      ...
                      if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                        return(
                          <td key={plan.gangNumber} colSpan={4} className='border-x-1 border-neutral-400 px-2'>{details.Overstow}</td>
                        )
                      }
                    })}
                ...
                return (
                  <tr className='border-b-1 border-neutral-500'>
                    ...
                    {gangDetailCars.gangPlanDetails.map((plan) => {
                      ...
                      if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                        return(
                          <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.Restow}</td>
                        )
                      }
                      if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                        return(
                      ...
                      if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                        return(
                          <td key={plan.gangNumber} colSpan={4} className='border-x-1 border-neutral-400 px-2'>{details.Restow}</td>
                        )
                      }
                    })}
                    <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-200'>{gangDetailCars.gangPlanDetails
                ...
                return (
                  <tr className='border-b-1 border-neutral-500'>
                    ...
                    {gangDetailCars.gangPlanDetails.map((plan) => {
                      ...
                      if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                        return(
                          <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2'>{details.Loads}</td>
                        )
                      }
                      if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                        return(
                      ...
                      if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                        return(
                          <td key={plan.gangNumber} colSpan={4} className='border-x-1 border-neutral-400 px-2'>{details.Loads}</td>
                        )
                      }
                    })}
                    <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-200'>{gangDetailCars.gangPlanDetails
            ...
            <tr className='border-b-1 border-neutral-700'>
              ...
              {gangDetailCars.gangPlanDetails.map((plan) => {
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                  return(
                    <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2 bg-neutral-200'>{(Number(details.NoOfVehicles) || 0) + (Number(details.ApwNoOfVehicles) || 0)}</td>
                  )
                }
                if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                  return(
                    <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2 bg-neutral-200'>{(Number(details.BBLK) || 0) + (Number(details.ApwBBLK) || 0)}</td>
                  )
                }
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                   return(
                    <>
                      <td key={plan.gangNumber} colSpan={3} className='border-x-1 border-neutral-400 px-2 bg-neutral-200'>{(Number(details.NoOfVehicles) || 0) + (Number(details.ApwNoOfVehicles) || 0)}</td>
                      <td key={plan.gangNumber} colSpan={1} className='border-x-1 border-neutral-400 px-2 bg-neutral-200'>{(Number(details.BBLK) || 0) + (Number(details.ApwBBLK) || 0)}</td>
                    </>
                  )
                }
              })}
              {gangDetailCars.gangPlanDetails.map((plan)=>{
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK === 0){
                  return(
                    <td colSpan={1 + gangDetailCars.gangPlanDetails.length} className='text-center bg-neutral-300'>
                      {gangDetailCars.gangPlanDetails.reduce((sum, plan) => sum + (Number(plan.details.NoOfVehicles) || 0), 0)}
                    </td>
                  )
                }
            ...
            {(() => {
              ...
              const totalShiftCols = gangDetailCars.gangPlanDetails.reduce(
                (sum, plan) => sum + getGangShiftCols(plan),
                0
              );
                        ...
                        {gangDetailCars.gangPlanDetails.map((plan, gangIdx) => {
                          ...
                          return (
                            <React.Fragment key={`${plan.gangNumber}-row-${i}`}>
                              ...
                              {/* BBLK has no Target/Actual/Variance - just a single blank column */}
                              {bothVehBblk && (
                                <td className='border-x-1 border-neutral-400 px-2 text-center bg-neutral-200'>{cell.bblkRaw != null ? cell.bblkRaw : '-'}</td>
                              )}
                            </React.Fragment>
                          );
                        })}
            ...
            <tr className='border-b-1 border-neutral-700'>
              ...
              {gangDetailCars.gangPlanDetails.map((plan)=>{
                ...
                if(details.NoOfVehicles === 0 && details.BBLK !== 0){
                  const totalLifts = (Number(plan.details.Discharge)) + (Number(plan.details.Overstow)) + (Number(plan.details.Restow)) + (Number(plan.details.Loads)) + (Number(plan.details.BBLK)) + (Number(plan.details.ApwBBLK));
                  const totalActual = plan.shiftPlanDetails.reduce((sum, shift)=>{
                    const shiftSum = (shift.liftTimePlanDetails || []).reduce((s, lt)=>{
                      const details = lt?.Details?.[0];
                      return s+ (Number(details?.Actual) || 0);
                ...
                if(details.NoOfVehicles !== 0 && details.BBLK !== 0){
                  const totalLiftsVeh = (Number(plan.details.Discharge)) + (Number(plan.details.Overstow)) + (Number(plan.details.Restow)) + (Number(plan.details.Loads)) + (Number(plan.details.NoOfVehicles)) + (Number(plan.details.ApwNoOfVehicles));
                  const totalLiftsBBLK = (Number(plan.details.Discharge)) + (Number(plan.details.Overstow)) + (Number(plan.details.Restow)) + (Number(plan.details.Loads)) + (Number(plan.details.BBLK)) + (Number(plan.details.ApwBBLK));
                  const totalActual = plan.shiftPlanDetails.reduce((sum, shift)=>{
                    const shiftSum = (shift.liftTimePlanDetails || []).reduce((s, lt)=>{
                      const details = lt?.Details?.[0];
                      return s+ (Number(details?.Actual) || 0);
